...
export default function Swipe() {
  ...
  return (
    <>
      <Head>
        <title>Hook Swipe File — HookScore</title>
        <meta name="description" content="45+ proven hook templates organized by type and platform. Copy, adapt, and post." />
      ...
      <div className="min-h-screen bg-black text-white">
        ...
        <main className="max-w-4xl mx-auto px-4 sm:px-6 py-10 pb-20">
          ...
          {/* Header */}
          <div className="mb-8">
            <h1 className="text-2xl sm:text-3xl font-black mb-1">Hook Swipe File</h1>
