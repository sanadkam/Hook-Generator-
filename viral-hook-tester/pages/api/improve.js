...
Step 1 â Score the original on these 5 dimensions (0â100 each):
- curiosityGap (30% weight): Does it force the viewer to keep watching? Open a loop they must close?
- emotionalTrigger (25% weight): Fear, hope, surprise, FOMO, relatability â how strong is the emotional pull?
...
overallScore = (curiosityGapÃ0.30) + (emotionalTriggerÃ0.25) + (clarityÃ0.20) + (platformFitÃ0.15) + (nicheRelevanceÃ0.10). Round to nearest integer.

Step 2 â Write 3 dramatically improved rewrites. Each one must:
- Directly fix the main weakness of the original
- Target a different psychological angle
- Sound natural and creator-authentic â not generic or AI-sounding
- Be genuinely stronger than the original â not just cosmetically different
...
Respond ONLY with valid JSON (no markdown, no explanation outside the JSON):
{
  "original": {
    ...
    "mainIssue": "The single biggest weakness holding this hook back â be specific"
  },
  "rewrites": [
    {
      ...
      "overallScore": number,
      "scores": { "curiosityGap": number, "clarity": number, "emotionalTrigger": number, "platformFit": number, "nicheRelevance": number },
      "whatChanged": "One precise sentence â what psychological lever did you pull and why is it stronger?"
    },
    {
