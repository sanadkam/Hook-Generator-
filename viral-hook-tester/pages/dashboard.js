...
const TOOLS = [
  ...
  { href: '/improve', title: 'Improve Hook', desc: 'Paste your existing hook and get an upgraded version instantly.' },
  { href: '/analyze', title: 'Analyze Hook', desc: 'Get a detailed score and breakdown of why your hook works.' },
        ...
        <main className="flex-1 px-4 py-12 max-w-3xl mx-auto w-full">
          ...
          {plan === 'free' && (
            <div className="bg-green-400/5 border border-green-400/20 rounded-2xl p-6 flex items-center justify-between gap-4">
              ...
              <Link href="/pricing" className="flex-shrink-0 px-5 py-2.5 bg-green-400 hover:bg-green-300 text-black font-bold rounded-xl text-sm transition-all">Upgrade</Link>
            </div>
          )}
        </main>
