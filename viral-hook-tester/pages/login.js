            ...
            {mode !== 'forgot' && (
              <>
                <button
                  ...
                  disabled={loading}
                  className="w-full py-3 mb-4 flex items-center justify-center gap-2.5 bg-white hover:bv-white/90 text-black font-semibold rounded-xl text-sm transition-colors disabled:opacity-50"
                >
